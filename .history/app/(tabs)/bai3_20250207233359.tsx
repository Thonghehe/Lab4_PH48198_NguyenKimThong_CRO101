...
export default function HomeScreen() {
    ...
    return (
        <SafeAreaView style={{ flex: 1, marginTop: Platform.OS === 'android' ? 50 : 0 }}>
            ...
            >
                <ScrollView contentContainerStyle={styles.container}>
                    ...
                    <Image source={require('../../assets/images/OIP.jpg')} style={{ width: 300, height: 300, marginBottom: 50, marginTop: 80 }} />
